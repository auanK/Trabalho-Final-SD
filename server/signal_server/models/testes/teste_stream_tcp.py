...
from models.UserRecord import UserRecord # Ajuste se necessário
...
# --- Lógica do Servidor TCP Simples ---
def server_logic():
    read_records = []
    ...
    try:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            with conn:
                ...
                # Usa makefile para obter um stream binário do socket [cite: 28]
...
def client_logic():
    ...
    try:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            # Usa makefile para obter um stream binário [cite: 19]
...
# server_thread.join(timeout=2) # Espera um pouco pelo servidor terminar
print("\n--- Fim do Teste TCP ---")